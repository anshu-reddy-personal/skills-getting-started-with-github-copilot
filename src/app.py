...
activities = {
    ...
    "Art Club": {
        ...
        "max_participants": 15,
        "participants": ["sarah@mergington.edu", "zane@mergington.edu"]
    },
    "Drama Club": {
        "description": "Rehearse scenes and perform plays for the school community",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["julia@mergington.edu", "cameron@mergington.edu"]
    },
    "Math Olympiad": {
    ...
    "Science Bowl": {
        "description": "Study science topics and compete in academic quiz bowls",
